  ...
  export default {
    ...
    methods: {
      ...
      loadMap(){
          ...
          let aymen = this.countries.map(function(item) {
              return [
                  convertData[item._id.iso_3166_1],item.value
              ];
          });
          let dataset={}
          ...
          return new Datamaps({
              ...
              geographyConfig: {
                  ...
                  popupTemplate: function(geo,data){
                      ...
                      console.log(['<div class="hoverinfo">',
