...
\begin{figure}[ht]
   \centering
   \includegraphics[width=0.7\linewidth]{../docs/mockup.png}
...
overview and allow the user to deep into the data to get more details about movies (fig. \label{fig:draft-overview}).
...
we clicked on the "Shutter Island" node to make its actors visible. These latters are fully connected
